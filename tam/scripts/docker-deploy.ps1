# TAM App Docker Deployment Script (PowerShell)
...
switch ($command.ToLower()) {
    ...
    "help" {
        Write-Host "Usage: .\docker-deploy.ps1 [command]" -ForegroundColor Cyan
        Write-Host ""
    ...
    default {
        ...
        Write-Host "Use '.\docker-deploy.ps1 help' for available commands" -ForegroundColor Yellow
    }
}
